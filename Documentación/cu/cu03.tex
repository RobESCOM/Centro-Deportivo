...
%\begin{UseCase}[archivo de imágen]{UCX}{Nombre del Caso de uso}{
	...
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso[\UCactor] Solicita la actualización de datos del cliente seleccionando la opción de ``Actualizar cliente'' de la \IUref{IU2}{Pantalla de opciones cliente.}
