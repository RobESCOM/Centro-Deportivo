...
%\begin{UseCase}[archivo de imágen]{UCX}{Nombre del Caso de uso}{
	...
	Con el fin de no hacer una eliminacion total si no parcial con el objetivo de activar nuevamente el servicio en el sistema.
		...
		\UCitem{Propósito}{Dar de baja un servicio del sistema, con el objetivo de que no se cuente su participación dentro del sistema y de la sucursal, sin embargo el servicio seguira existiendo pero con un estado inactivo.}
