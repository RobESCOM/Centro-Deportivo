...
%\begin{UseCase}[archivo de imágen]{UCX}{Nombre del Caso de uso}{
	\begin{UseCase}{CU6.0}{Consultar Áreas Registradas}{
		...
		\UCitem{Postcondiciones}{El actor podrá regresar al menú de opciones para realizar otras operaciones en el sistema. \IUref{IU8}{Pantalla para regresar al menu.}}
