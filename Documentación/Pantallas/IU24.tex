...
\IUfig[1]{gui/mapaU}{IU33}{Pantalla de visualización de sucursal en mapa.}
...
\subsection{IU100 Venta/compra de membresía}

\subsubsection{Objetivo}
	Muestra la interfaz con la cual el cliente puede ver los tipos de membresía y los beneficios asociados a cada una, para que pueda adquirir la que crea conveniente a sus necesidades.

\subsubsection{Diseño}
	Esta interfaz aparace al cargar la pagina principal. 

\IUfig[1]{gui/ventaCompra}{IU100}{Venta/compra de membresía}

\subsubsection{Salidas}

	Los tipos de membresía y los beneficios asociados a cada una.

\subsubsection{Entradas}
	Selección por parte del cliente la membresía.

\subsubsection{Comandos}
\begin{itemize}
	\item \IUbutton{Entrar}: Muestra en forma tablar las sucursales registradas en el sistema. sucursal \IUref{IU100}{Venta/compra de membresía}.
	\item \IUbutton{Ayuda}: Muestra la ayuda de esta pantalla \IUref{IU50}{Pantalla de Ayuda}.
\end{itemize}
