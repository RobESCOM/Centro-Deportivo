...
<div class="middle">
        ...
        <div class="panelL"> 
            ...
            <div class="pbtn">
                ...
                <tr>
                    <td id="filtro" style="color: #9E9E9E;"><input type="radio" name="filtro" value="0" <%if(option==0){%>checked<%}%> required>Sucursal</td>
                </tr>
                <tr>
                    <td id="filtro" style="color: #9E9E9E;"><input type="radio" name="filtro" value="1" <%if(option==1){%>checked<%}%> >Membresia</td>
                </tr>
                <tr>
                    <td id="filtro" style="color: #9E9E9E;"><input type="radio" name="filtro" value="2" <%if(option==2){%>checked<%}%> >Servicio</td>
                </tr>
                <tr>
                    <td id="filtro" style="color: #9E9E9E;"><input type="radio" name="filtro" value="3" <%if(option==3){%>checked<%}%> >Socio</td>
                </tr>
                <tr>
                    <td id="filtro" style="color: #9E9E9E;"><input type="radio" name="filtro" value="4" <%if(option==4){%>checked<%}%> >Empleado</td>
                </tr>
            </table>                    
