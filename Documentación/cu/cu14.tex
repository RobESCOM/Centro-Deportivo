...
\begin{UseCase}{CU14}{Ubicar geográficamente una sucursal}{
	...
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso Pone un icono sobre el mapa en pantalla que señala la ubicación de la sucursal más cercana al actor. \Trayref{A}
	...
	\begin{UCtrayectoriaA}{A}{No se puede saber la ubicación del actor.}
		...
		\UCpaso Continua en el paso \ref{CU14MostarSuc} del \UCref{CU14}.
	\end{UCtrayectoriaA}
