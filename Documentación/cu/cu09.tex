...
{\bf E8:} ``Nombre de área ya existente'' -- El sistema muestra el Mensaje {\bf MSG8-}``El nombre de área ya se encuentra registrado.''}
	...
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso[\UCactor] Selecciona la opción de actualizar datos. \IUref{IU18}{Pantalla de menu de opciones áreas}.
		...
		\UCpaso Muestra una pantalla, en ella un formulario con los datos del área que se desea modificar.\IUref{IU22}{Pantalla para actualización de áreas}.
