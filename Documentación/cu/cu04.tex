...
%\begin{UseCase}[archivo de imágen]{UCX}{Nombre del Caso de uso}{
	\begin{UseCase}{CU4}{Dar de baja un cliente.}{
		...
		\UCitem{Revisor}{Isaac Fernández Quiñones}
	\end{UseCase}

	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Solicita el ingreso al apartado de clientes, seleccionando la opción de ``Clientes'' que aparece en la \IUref{IU1}{Página principal.}
		\UCpaso Muestra las operaciones disponibles para el actor mediante la \IUref{IU2}{Pantalla de opciones cliente.}
		\UCpaso[\UCactor] Solicita la baja del registro del cliente seleccionando la opción de ``Eliminar cliente'' de la \IUref{IU2}{Pantalla de opciones cliente.}
		...
		\UCpaso[\UCactor] Solicita la baja del registro del cliente seleccionando la opción de ``Baja'' de la \IUref{IU9}{Pantalla de Búsqueda de Cliente.}  
